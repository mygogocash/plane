...
> (WF-T1–T9) and its frontend store/service/types (WF-T10) are done**; the remaining
> Workflows work is the UI (WF-T11–T13). All dependency upgrades (Django 5.2, React 19,
...
| --------------------- | ----------------------------------------------- | ------------------------------------- | ----------------------------------------- | --------------------------------------- | ------------------------------------- | ------------------------------------------------------------------ |
| Workflows & Approvals | [PRD](../prd-workflows-approvals-2026-06-07.md) | [epics](workflows-approvals/epics.md) | [stories](workflows-approvals/stories.md) | [design](workflows-approvals/design.md) | [tasks](workflows-approvals/tasks.md) | 🟢 Backend done (WF-T1–T9) + store (WF-T10); UI WF-T11–T13 pending |
