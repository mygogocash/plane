...
> (WF-T1–T9), frontend store/service/types (WF-T10) are done, and CE enforcement components
> (WF-T11) are done**; the remaining Workflows work is the UI (WF-T12–T13). All dependency upgrades (Django 5.2, React 19,
...
| --------------------- | ----------------------------------------------- | ------------------------------------- | ----------------------------------------- | --------------------------------------- | ------------------------------------- | -------------------------------------------------------------------------------------------- |
| Workflows & Approvals | [PRD](../prd-workflows-approvals-2026-06-07.md) | [epics](workflows-approvals/epics.md) | [stories](workflows-approvals/stories.md) | [design](workflows-approvals/design.md) | [tasks](workflows-approvals/tasks.md) | 🟢 Backend done (WF-T1–T9) + store (WF-T10) + CE enforcement (WF-T11); UI WF-T12–T13 pending |
