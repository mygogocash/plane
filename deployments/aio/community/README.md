...
This AIO image is not the GoGoCash/Manut production release path. The
`preview` branch deploys split Plane component images to Google Artifact
Registry and rolls GKE workloads through `.github/workflows/ci-cd.yml`; do not
