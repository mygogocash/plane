...
export function PlaneLockup({ width = "253", height = "53", className, color = "currentColor" }: ISvgIcons) {
  return (
    <svg
      ...
      className={className}
    >
      <rect x="0.5" y="0.5" width="51" height="51" rx="13.5" fill={MANUT_MARK_BACKGROUND} />
      <path
        d="M14.5 38V15.5H20.2L26 27.3L31.8 15.5H37.5V38H32V25.4L27.8 34H24.2L20 25.4V38H14.5Z"
        fill={MANUT_MARK_FOREGROUND}
      />
      <path d="M39.5 17.5H43.5V38H39.5V17.5Z" fill={MANUT_MARK_FOREGROUND} opacity="0.75" />
