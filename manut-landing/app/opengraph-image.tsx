  ...
  return new ImageResponse(
    <div
      style={{
        ...
        padding: "72px",
        background: "linear-gradient(135deg, #fafaf2 0%, #f4ece2 60%, #ecdcd2 100%)",
    ...
    >
      ...
      >
        <img src={logo} alt="" width={120} height={120} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
      </div>
      ...
      >
        ...
        >
          Projects, work items, cycles, modules, intake, views, pages, and AI-assisted workflows.
        </div>
      </div>
