      ...
      <div className="container-prose">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-5 text-pretty text-base text-muted-foreground sm:text-lg">
            Manut is presented as an access-controlled production app. Existing
            users sign in; new teams request access; technical reviewers can
            inspect the source.
          </p>
        </Reveal>
          ...
          {accessOptions.map(option => (
            ...
            >
              ...
              <ButtonLink
                ...
                target={
                  option.cta.href.startsWith('http') ? '_blank' : undefined
                }
                rel={
