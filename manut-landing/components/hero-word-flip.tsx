...
const HERO_WORDS = ["modules", "intake", "views", "pages", "handoffs", "activity"] as const;
...
export function HeroWordFlip({ className }: { className?: string }) {
  ...
  return (
    <span className={cn("hero-word-flip inline align-baseline", className)} aria-live="polite" aria-atomic="true">
      <span
