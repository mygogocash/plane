...
export const siteConfig = {
  ...
  accessRequestHref: "mailto:hello@manut.xyz?subject=Manut%20access%20request",
  ogImageAlt:
...
export const accessOptions: ReadonlyArray<AccessOption> = [
  {
    ...
    blurb: "Use the production app when your account already has access to a Manut workspace.",
    details: ["Email and password sign-in", "Magic-link access", "Workspace sidebar, projects, and work items"],
  ...
  },
  {
    ...
    blurb: "Tell GoGoCash your team size and use case so access can be enabled intentionally.",
    details: ["No public signup promise", "Use-case review by the operator", "Workspace setup handled through support"],
  ...
  },
  {
    ...
    blurb: "Review the landing page source, release notes, and operational changes in the GitHub repository.",
    details: ["Public repository link", "Release history", "Issue tracker for feedback"],
...
export const quickAnswers: ReadonlyArray<FaqItem> = [
  ...
  },
  {
    ...
    answer: "The production Manut app runs at https://app.manut.xyz and the public landing page is https://manut.xyz.",
  },
  {
...
export const faqs: ReadonlyArray<FaqItem> = [
  ...
  },
  {
    ...
    answer: "The production instance currently reports Manut app version v1.3.1 in the app instance API.",
  },
  {
