      ...
      <div className="mt-8 space-y-5">
        {sidebarOptions.map((option) => (
          <button
            type="button"
            key={option.key}
            className={`flex cursor-pointer items-center gap-2 border-l-[3px] bg-transparent py-0.5 pr-2 pl-3 text-left text-13 font-medium capitalize ${
