...
const helpOptions = [
  ...
  {
    name: "Report a bug",
    href: "https://github.com/mygogocash/plane/issues/new/choose",
    Icon: GithubIcon,
  },
];
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-1 ${isSidebarCollapsed ? "flex-col justify-center" : "w-full"}`}>
        <Tooltip tooltipContent="Redirect to Manut" position="right" className="ml-4" disabled={!isSidebarCollapsed}>
          <a
          ...
          >
            ...
            {!isSidebarCollapsed && "Redirect to Manut"}
          </a>
        </Tooltip>
